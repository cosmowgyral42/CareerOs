...
function SkillGaps() {
  ...
  async function removeGap(skillGapId) {
    ...
    <div className="mx-auto max-w-7xl space-y-8">
      <section>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
          ...
          important gaps into actionable development work.
        </p>
      </section>
      ...
      {skillGaps.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-pink-200 bg-white p-12 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Your skill-gap records will appear here once
            they are created for a career target.
          </p>
        </div>
      ) : (
          ...
          {skillGaps.map((gap) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <span className="rounded-full bg-[#FFF8E7] px-3 py-1 text-xs font-bold text-amber-700">
                  {gap.importance}
                </span>
              </div>
              ...
              <button
                ...
                className="mt-5 rounded-lg border border-red-100 px-3 py-2 text-xs font-bold text-red-500 hover:bg-red-50 disabled:opacity-50"
              >
                {deletingId === gap.id
                  ? 'Removing...'
                  : 'Remove gap'}
